...
def webhook():
  ...
  if data['group_id']==os.getenv('GROUP_ALERT') and data['name'] != 'Secretary of Coreyboulet'and 'the group.' not in mess and 'changed name'not in mess and 'has joined'not in mess and  ('@raid' in mess or 'T5' in mess or 'hatched' in mess or 'hatches'  in mess):
  	strings=mess.split()
  	gym=""
  	time=""
  	pokemon=""
